...
public class CornerSelectActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Taking address of the bluetooth which we selected in Arraylist in ImageProcessingActivity //
        ...
        imgUri = Uri.parse(getIntent().getStringExtra(ImageProcessingActivity.IMAGE_URI));
        loadDisplayImage();
        ...
        solveMazeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mBundle.putString(ImageProcessingActivity.IMAGE_URI, imgUri.toString());
                mIntent.putExtras(mBundle);
                mIntent.putExtra(DEVICE_EXTRA, Device);
                mIntent.putExtra(DEVICE_UUID, DeviceUUID.toString());

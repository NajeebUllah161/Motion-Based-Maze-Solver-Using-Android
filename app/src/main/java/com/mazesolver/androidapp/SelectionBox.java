...
public class SelectionBox extends View {
    ...
    // The x-y coordinates of the four corners
    ...
    // width The width that the dots may move from (0 to width)
    // height The height that the dots may move from (0 to height)

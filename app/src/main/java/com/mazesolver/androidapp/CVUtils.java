...
public class CVUtils {
    ...
    // The Mat representing an image
    // The bounds of the subsection of the Mat to perform the transform on
    // A flag to perform an inverse transform.
    // The transformed Mat.
    ...
    // The four points defining the bounds of the section to be cropped
    // The cropped Mat padded with white.
    ...
    // The Mat containing the maze.
    // A list containing the two largest-perimeter contours.
    ...
    // The contour to be tested.
    // Whether or not the contour is a square.
    ...
    // The Mat to draw the contours on.
    // The contours to draw.
    // A Mat with contours drawn on it.
    ...
    // The Mat to draw the rectangles on.
    // The rectangles to draw.
    // A Mat with rectangles drawn on it.
    ...
    // An OpenCV rectangle that's the union of r1 and r2.
